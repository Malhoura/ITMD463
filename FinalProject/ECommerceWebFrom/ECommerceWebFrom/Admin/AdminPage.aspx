<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="ECommerceWebFrom.Admin.AdminPage" %>
...
<h1>Administration</h1>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    ItemType="ECommerceWebFrom.Models.Category" 
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="ECommerceWebFrom.Models.Product" 
    ...
    <asp:Button ID="EditProductButton" runat="server" Text="Edit Product" OnClick="EditProductButton_Click" CausesValidation="false"/>
